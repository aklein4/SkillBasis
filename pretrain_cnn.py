...
class Sampler:
    def __init__(
        ...
        self.env = ProcgenGym3Env(num=num_envs, env_name="coinrun", use_sequential_levels=True, use_backgrounds=False, restrict_themes=True, use_monochrome_assets=True)
