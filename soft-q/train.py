...
LR = 1e-4
BATCH_SIZE = 16
BUFFER_SIZE = 50 * N_EPISODES * SAMPLE_BATCH_SIZE * 10 - 1
...
def main():
    ...
    logger = Logger(pi_model, encoder_model, basis_model, OUTPUT_DIR, SAVE_EVERY)
    ...
    trainer = Trainer(env, pi_model, encoder_model, basis_model, logger)
